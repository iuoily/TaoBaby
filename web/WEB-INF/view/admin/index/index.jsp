		...
		$('.change-password').on('click', function (){
			layer.open({
				title: "修改密码",
			  	...
			  	fixed: false, //不固定
			  	maxmin: true,
			  	content: basePath + '/admin/user/changePasswordPage'
			});
			return false;
		})
	})
				...
				<li class="hp-nav-item">
					...
					<dl class="hp-nav-child">
						<dd>
							<div>
								<span class="hp-nav-tree-bar"></span>
								<a href="${ctx}/admin/user/list">用户维护</a>
							</div>
						</dd>
					</dl>
				</li>
				<li class="hp-nav-item">
					...
					<dl class="hp-nav-child">
						<dd>
							<div>
								<span class="hp-nav-tree-bar"></span>
								<a href="${ctx}/admin/carouselfigure/list">轮播图维护</a>
							</div>
						</dd>
					</dl>
				...
				<li class="hp-nav-item">
					...
					<dl class="hp-nav-child">
						<dd>
							<div>
								<span class="hp-nav-tree-bar"></span>
								<a href="${ctx}/admin/brand/list">商品品牌维护</a>
							</div>
						</dd>
					</dl>
				</li>
				<li class="hp-nav-item">
					...
					<dl class="hp-nav-child">
						<dd>
							<div>
								<span class="hp-nav-tree-bar"></span>
								<a href="${ctx}/admin/product/list">商品维护</a>
							</div>
						</dd>
					</dl>
				</li>

...
<body>
	<div class="hp-context-page">
		...
		<form action="${ctx}/admin/product/update" class="hp-form" id="product-from">
			...
			<div class="hp-form-item">
				<img alt="" src="${ctx}/common/getImage?image=${product.productImage }" id="productImage" width="200px" name="productImage">
			</div>
			<div class="hp-form-item">
			...
			<div class="hp-form-item" id="productDesc">
				<c:forEach items="${product.productDesc}" var="img">
					<img alt="" style="padding-right: 10px;" src="${ctx}/common/getImage?image=${img}" width="50px">
				</c:forEach>
			</div>
			<div class="hp-form-item">

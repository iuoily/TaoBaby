...
<html>
	...
	<body>
		...
		<div class="w1230 clear-float goods-main">
			<div class="big-img">
				<img src="${ctx }/common/getImage?image=${product.productImage}" />
			</div>
		...
		<div class="w1230 clear-float">
			...
			<div class="goods-des">
				...
				<div class="goods-info">
					<ul>
						<c:forEach var="url" items="${fn:split(product.productDesc,',')}">
							<li><img src="${ctx }/common/getImage?image=${url}" alt="" /></li>
						</c:forEach>
					</ul>
				</div>
			</div>	

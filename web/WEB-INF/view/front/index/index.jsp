		...
		<div class="top" id="top">
			...
			<div class="top-header w1230 clear-float">
				<a href="${ctx}/front/index" class="logo">
					<img src="${ctx}/static/img/logo.png" width=""/>
				</a>
				<div class="top-header-right">
					<!--搜索框-->
					<div class="search clear-float">
						<input type="text"  placeholder="java" class="search-txt"/>
			...
			<div class="banner" id="main">
				<ul id="pic">
					<c:forEach var="carouselFigure" items="${allcarouselFigures}">
						<li><a href="#"><img src="${ctx}/common/getImage?image=${carouselFigure.url}" alt="" width="1020px" height="360px"/></a></li>
					</c:forEach>
				</ul>
